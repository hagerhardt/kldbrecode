...
{title:Syntax}
        ...
        {cmd:kldb10_3d_to_kldb10_2d(}{varname}{cmd:)}
...
{pstd}
    {helpb kldbrecode} table translating KldB-2010 occupationals groups (3 digit codes) to KldB-2010 occupational main groups (2 digit codes) using {helpb crosswalk}.
